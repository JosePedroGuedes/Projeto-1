...
dialogMap[6] = '"A sério que errei a pergunta? Agora vou ter de começar tudo de novo."';
dialogMap[7] = '"Jurava que esta era a resposta certa."';
dialogMap[8] = '"Mais valia ter feito ao sorteio, que talvez acertasse."';
dialogMap[9] = 'Parabéns!! Acertou a todas as perguntas!! Já pode aceder à porta final do Escape Room!!';
...
dialogMap[13] = '"Para poder aceder a esta porta falta-me primeiro encontrar onde está o código dela. Deve estar em um bilhete por aí algures."';
dialogMap[14] = "Complete os outros desafios para poder aceder a esta porta.";
dialogMap[15] = '"Preciso de encontrar uma maneira de abrir esta porta."';
dialogMap[16] = '"Tem de primeiro completar os outros desafios para ter acesso à porta!"';
...
dialogMap[19] = '"Pensávamos que ninguém iria conseguir entrar nesta sala. Estamos impressionados!! Serás recompensado por o conseguires. Mas não é suposto estares aqui, por isso SAI!!"';
...
dialogMap[26] = 'A imagem da Esmad foi dividida em 9 peças e espalhadas aleatoriamente. O seu objetivo é reconstruir a imagem, movendo as peças, trocando-as de posição com o espaço vazio.';
